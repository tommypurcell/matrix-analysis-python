...
coord = 1000 * np.array([
    ...
    [0, 0, 30], [10, 0, 30], [10, 10, 30], [0, 10, 30]
])
# External nodal forces
concen = np.zeros((nnodes, 6))
concen[12:16, 2] = -2
concen[15, 1] = 3
...
# Fixity (0 for fixed, np.nan for free)
fixity = np.full((nnodes, 6), np.nan)
fixity[0:4, 0:3] = 0
# Number of elements and element connections
nele = 32
ends = np.array([
    [1, 13], [2, 14], [3, 15], [4, 16],
    [1, 6], [2, 5], [2, 7], [3, 6], [3, 8], [4, 7],
    [4, 5], [1, 8], [5, 10], [6, 9], [6, 11], [7, 10],
    [7, 12], [8, 11], [8, 9], [5, 12], [9, 14], [10, 13],
    [10, 15], [11, 14], [11, 16], [12, 15], [12, 13],
    [9, 16], [13, 14], [14, 15], [15, 16], [16, 13]
]) 
